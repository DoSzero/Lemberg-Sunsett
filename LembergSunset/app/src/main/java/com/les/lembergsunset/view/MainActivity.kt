package com.les.lembergsunset.view
...
import com.les.lembergsunset.R
import com.les.lembergsunset.api.ApiUtilities
import com.les.lembergsunset.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val LOCATION_ACCES_CODE = 102
    private val LOCATION_IN_PROGRESS = 103

    private val apiKey="82e72b8be0e0e2fbb38abc966a6dfc31"
            ...
            if (isLocationEnabled()){
                ...
                fusedLocationProvider.lastLocation.addOnSuccessListener { location ->
                    if (location != null) {
                        ...
                        Log.d("Loc", fusedLocationProvider.toString())
                    } else {
                        // Lviv = Lem-berg
                        fetchCurrentLocationWeather(
                            "49.84",
